/// Minimal 8×8 bitmap font for the overlay HUD.
/// Each glyph is 8 rows of 8 bits. Only ASCII 0x20–0x7E are covered.
/// Bit 7 (MSB) is the leftmost pixel.

/// Returns a reference to the 8-byte glyph bitmap for `ch`.
...
// Classic 8x8 bitmap font (CP437-style). Each entry = 8 bytes, one per row, MSB left.
static FONT: [[u8; 8]; 95] = [
    // 0x20 SPACE
